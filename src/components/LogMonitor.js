            ...
            <View style={styles.line} key={i}>
              ...
              <View>
                ...
                <View style={styles.foregroundRow}>
                  <TouchableHighlight style={{flex: 1}} underlayColor='#0005' onPress={()=>this._decAction(a)}>
                    <View style={{flex: 1}} />
                  </TouchableHighlight>
                  <TouchableHighlight style={{flex: 1}} underlayColor='#0005' onPress={()=>this._incAction(a)}>
                    <View style={{flex: 1}} />
                  </TouchableHighlight>
                </View>
              </View>
              <View>
                ...
                <View style={styles.foregroundRow}>
                  <TouchableHighlight style={{flex: 1}} underlayColor='#0005' onPress={()=>this._decState(a)}>
                    <View style={{flex: 1}} />
                  </TouchableHighlight>
                  <TouchableHighlight style={{flex: 1}} underlayColor='#0005' onPress={()=>this._incState(a)}>
                    <View style={{flex: 1}} />
                  </TouchableHighlight>
                </View>
              </View>
